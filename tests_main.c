...
static struct test_info {
        ...
        {"folder4/halt1", NULL, "", build_halt_test1},
        {"folder4/out1", NULL, "A", build_out_test1},
        {"folder4/out2", NULL, 
                "A B C D E F \nB C D E F G \n", build_out_test2},
        {"folder4/input1", "qwert", "qwert", build_input_test1},
        {"folder4/input2", "Hello", "Hello", build_input_test2},
        {"folder4/cmov1", NULL, "2F", build_cmov_test1},
        ...
        {"folder4/loadp1", NULL, "", build_loadp_test1},
        {"folder4/loadp2", NULL, "", build_loadp_test2}
};
